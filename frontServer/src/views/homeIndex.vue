  ...
  <div class="content">
    ...
    <div class="under">
      <div class="search">
        ...
        <div style="display: flex; width: 70vw; transform: translateX(0.5vw)">
          <!-- 数据表 -->
          <el-table :data="tableData" style="width: 70vw" height="610px">
            <!-- Token名称表 宽150 -->
 ...
 */
const reNew = () => {
  ElMessageBox.alert("该功能还在开发中!", "温馨提醒", {
    confirmButtonText: "OK",
    callback: () => {
      ElMessage({
        type: "info",
        message: "等待Pandora大佬出一个更好的方法！",
      });
    },
  });
};
...
const formatDate = (value) => {
  if (!value) return "";
  var nowDay = new Date();
  var timeDay = new Date(value);
  let dateDiff =
    Math.ceil(nowDay.getTime() - timeDay.getTime()) / (1000 * 60 * 60 * 24);
  return dateDiff >= 15
    ? "已经过去了至少15天"
    : Math.ceil(15 - dateDiff) + "天";
};
